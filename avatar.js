...
function avatarSVG(value,size=96){
  ...
  const hairShapes=[
    ...
    `<path d="M27 43 Q28 12 60 10 Q93 13 94 44 L91 91 Q79 82 75 67 L45 67 Q41 82 29 91Z" fill="${hair}"/><path d="M31 42 Q31 15 60 13 Q89 15 89 42 Q74 28 60 33 Q45 27 31 42Z" fill="${hair}"/>`,
