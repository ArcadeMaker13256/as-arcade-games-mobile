const CACHE='as-arcade-mobile-v11-3';
const CORE=['./','./index.html','./styles.css?v=11.3','./avatar.js?v=11.3','./games.js?v=11.3','./games.json?v=11.3','./game-engines.js?v=11.3','./extra-engines.js?v=11.3','./v11-engines.js?v=11.3','./app.js?v=11.3','./manifest.webmanifest?v=11.3','./arcade-logo.png?v=11.3','./favicon-32.png?v=11.3','./apple-touch-icon.png?v=11.3','./apple-touch-icon-v10.png?v=11.3','./icon-192.png?v=11.3','./icon-512.png?v=11.3','./maskable-192.png?v=11.3','./maskable-512.png?v=11.3'];
