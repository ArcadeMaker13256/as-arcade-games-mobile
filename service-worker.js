const CACHE='as-arcade-github-v7';
const CORE=['./','./index.html','./styles.css','./app.js','./games.js','./games.json','./manifest.webmanifest','./assets/logo.png','./icons/icon-192.png','./icons/icon-512.png'];
