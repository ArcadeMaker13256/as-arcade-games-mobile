const CACHE='as-arcade-mobile-v11-7';
const CORE=['./','./index.html','./styles.css?v=11.7','./avatar.js?v=11.7','./games.js?v=11.7','./games.json?v=11.7','./game-engines.js?v=11.7','./extra-engines.js?v=11.7','./v11-engines.js?v=11.7','./app.js?v=11.7','./manifest.webmanifest?v=11.7','./arcade-logo.png?v=11.7','./favicon-32.png?v=11.7','./apple-touch-icon.png?v=11.7','./apple-touch-icon-v10.png?v=11.7','./icon-192.png?v=11.7','./icon-512.png?v=11.7','./maskable-192.png?v=11.7','./maskable-512.png?v=11.7'];
