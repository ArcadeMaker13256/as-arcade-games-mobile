const CACHE='as-arcade-mobile-v9-75-unique';
const CORE=['./','./index.html','./styles.css?v=9.0','./avatar.js?v=9.0','./games.js?v=9.0','./games.json?v=9.0','./game-engines.js?v=9.0','./extra-engines.js?v=9.0','./app.js?v=9.0','./manifest.webmanifest','./assets/arcade-logo.png?v=9.0','./icons/icon-192.png?v=9.0','./icons/icon-512.png?v=9.0'];
