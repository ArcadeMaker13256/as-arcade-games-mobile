...
function migrateDB(d){
  ...
  for(const a of d.accounts){
    ...
    a.settings=Object.assign({theme:'neon',wallpaper:'stars',reducedMotion:false,highContrast:false,sound:true,volume:.7,visualEffects:true,botDifficulty:'medium',getReadySeconds:5,controlSize:'normal',textSize:'normal',cardSize:'normal',gamePace:'standard',customTheme:{bg:'#071329',panel:'#101f42',card:'#162c58',accent:'#31d5ff',accent2:'#ff4fd8',text:'#f7fbff'}},a.settings||{});
